...
<head>
    ...
    <title>GrandStream Phone Book | VERTIV GULF LLC ITMS</title>
...
<div class="sidebar">
    ...
    <a href="grandstream.php" style="background-color: #1a1a1a;"><i class="material-icons">arrow_right</i> GrandStream</a>
    <a href="logout.php" class="logout-link"><i class="material-icons">logout</i> Logout</a>
</div>

<div class="main-content">
    <div class="header-section">
        <div class="tab-header">GrandStream Phone Book Registry</div>
    </div>
...
function createTableRow(data, index) {
    ...
    row.innerHTML = `
        ...
        <td style="font-weight:500; color:var(--text-main)">${data.firstname}</td>
        <td>${data.lastname}</td>
...
function loadEntries() {
    fetch('get_grandstream_entry.php')
    .then(res => res.json())
    .then(data => {
        tbody.innerHTML = '';
...
function attachRowButtons(row) {
    ...
    row.querySelector('.edit-btn').addEventListener('click', () => {
        ...
        form.phonenumber.value = row.cells[3].textContent;
        form.entry_date.value = row.cells[4].textContent;
        form.entry_time.value = convertTo24Hour(row.cells[5].textContent);
